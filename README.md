# qiaomu-image-generator

> Use when user requests image generation for articles, papers, covers, or social media.

## 安装

```bash
npx skills add joeseesun/qiaomu-image-generator
```
